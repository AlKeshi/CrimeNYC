...
################################ Creating Mask #################################
# Updated for NYC data dimensions: 67x50 (height x width)
mask = np.ones((67, 50))
...
# Create data with shape (3653, 67, 50, 1) with 3653 timesteps
# Updated dimensions for NYC: 67x50
data = np.random.random((3653, 67, 50, 1))
...
# Updated for NYC data dimensions: 67x50
inputs = Input(shape=(lookback, 67, 50, 1))
